...
- `npm run automation:runtime:http:verify` to exercise all three runtime bridge routes through real local HTTP requests
...
- Record what changed, what was validated, whether the `automation-smoke-report` artifact was checked, and what stayed blocked by design.
